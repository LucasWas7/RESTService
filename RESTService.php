<?php 
	...
	function getStudents() {
		$content = @file_get_contents('http://localhost:8080/SisWebRest/api/v1/students/1');
	...
	function getStudentsList() {
		$content = @file_get_contents('http://localhost:8080/SisWebRest/api/v1/students');
	...
	function saveStudent() {
		$data = array(
		    ...
		    'lastName' => 'Butron',
		    'firstName' => 'Lucas',
		    'classCodes' => array('inf-101', 'adm-101')
		);
